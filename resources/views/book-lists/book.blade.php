<x-app-layout>
    ...
    <div class="pt-2 text-lg border shadow-md border-slate-800 shadow-slate-600">
        ...
        <div class="flex items-center justify-between">
            ...
            <div x-data="{ show: false }" @click.away="show = false" class="m-3">
                <div @click="show = ! show" class="flex items-center">
                    <button
                        class="inline-flex items-center justify-center transition duration-150 ease-in-out rounded-md focus:outline-none focus:bg-slate-800 focus:text-slate-300">
