<x-app-layout>
    ...
    <div class="text-lg text-center border shadow-md pb-7 text-slate-300 border-slate-800 shadow-slate-600">
        ...
        <p class="p-1 italic">{!! $book->description ?? null !!}</p>
    </div>
</x-app-layout>
