<div class="mx-auto border-slate-600 p-4 bg-zinc-200 dark:bg-zinc-800 shadow-lg">
    <form action="{{ route('results.show') }}"
        ...
        <div class="relative flex w-full max-w-md flex-col gap-1 text-neutral-600 dark:text-neutral-300">
            ...
            <input type="search" class="w-full rounded-sm border border-neutral-300 bg-neutral-50 py-2 pl-10 pr-2 text-base focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75 dark:border-neutral-700 dark:bg-neutral-900/50 dark:focus-visible:outline-white" name="bookSearch" placeholder="Search for a book or author" aria-label="search"/>
        </div>
    </form>
</div>
