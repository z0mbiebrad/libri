...
@isset($book->title)
    <h5 class="p-1 py-2 text-base underline border rounded-md border-slate-600 ">
        {{ $book->title }}</h5>
@endisset
@isset($book->subtitle)
    <h5 class="p-1 py-2 text-base border rounded-md border-slate-600 ">
        {{ $book->subtitle }}</h5>
@endisset
@isset($book->authors)
    <h5 class="p-1 py-2 text-base border rounded-md border-slate-600 ">
...
@isset($book->categories)
    <p class="p-1 py-2 text-base italic border rounded-md border-slate-600 ">
        {{ $book->categories }}</p>
@endisset
@isset($book->published_date)
    <p class="p-1 py-2 text-base italic border rounded-md border-slate-600 ">Published
