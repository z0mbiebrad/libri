<x-app-layout>
    ...
    <div>
        ...
        <div class="text-lg text-center border shadow-md py-7 text-slate-300 border-slate-800 shadow-slate-600">
            ...
            <h5 class="p-1 py-2 underline border rounded-md shadow-md border-slate-600 shadow-slate-600">
            ...
            <p class="p-1 py-2 italic border rounded-md shadow-md border-slate-600 shadow-slate-600">
                {{ $book->volumeInfo->categories[0] ?? null }}
            </p>
            <p
                class="flex items-center justify-center p-1 py-2 italic border rounded-md shadow-md border-slate-600 shadow-slate-600">
                Rating:
            ...
            <p class="p-1 py-2 italic border rounded-md shadow-md border-slate-600 shadow-slate-600">Published Date:
                {{ $book->volumeInfo->publishedDate ?? null }}
            </p>
            <p class="py-2 pt-1 text-base border rounded-md shadow-md border-slate-600 shadow-slate-600">
